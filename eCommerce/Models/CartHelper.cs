...
{
    /// <summary>
    /// Contians helper methods to manage the users shopping cart
    /// </summary>
    public class CartHelper
    {
        private const string CartCookie = "Cart";
        /// <summary>
        /// Gets the current user VideoGames from their shopping car. If there are no games, an aempty list is returned
        /// </summary>
